...
const prdRelativePath = "cases/prds/data-assets/v6.4.10/PRD-26-数据质量-质量问题台账.md";
...
assert(
  /(^|\n)prd_path:\s*cases\/prds\/data-assets\/v6\.4\.10\/PRD-26-数据质量-质量问题台账\.md/.test(fixedArchive),
