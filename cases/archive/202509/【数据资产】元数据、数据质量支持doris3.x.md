...
##### 【P1】验证「质量报告」中 Doris 3.x 数据源「自定义报告」的配置和生成功能正常
...
##### 【P1】验证「质量报告」中 Doris 3.x 数据源「单表报告」的配置和生成功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源规则任务的周期调度设置功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源「自定义SQL」功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源「统计性校验」功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源「完整性校验-多表数据行数对比校验」功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源 「完整性校验-多表数据内容对比校验」功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源 「完整性校验-单表校验」功能正常
...
##### 【P1】验证「规则任务配置」中 Doris 3.x 数据源 「完整性校验-字段级校验」功能正常
...
##### 【P1】验证「平台管理」中 Doris 3.x 数据源质量项目授权功能正常
...
##### 【P1】验证 「元数据」中 Doris 3.x 元数据周期同步功能正常
...
##### 【P1】验证 「元数据」中 Doris 3.x 数据表查询和表数量显示正常
