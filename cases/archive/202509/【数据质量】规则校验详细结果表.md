...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「Z-score置信区间」-「校验失败」逻辑正确
...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「Z-score置信区间」-「校验通过」逻辑正确
...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「IQR离群点占比」-「校验失败」逻辑正确
...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「IQR离群点占比」-「校验通过」逻辑正确
...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「IQR离群点数量」-「校验失败」逻辑正确
...
##### 【P1】验证「统计性校验」-「字段级-异常值检测」-「IQR离群点数量」-「校验通过」逻辑正确
...
##### 【P1】验证「唯一性校验」-「多表-多表唯一性检测」-「校验异常」逻辑正确
...
##### 【P1】验证「唯一性校验」-「多表-多表唯一性检测」-「校验通过」逻辑正确
...
##### 【P1】验证「唯一性校验」-「字段级-重复率」-「固定值」-「校验异常」逻辑正确
...
##### 【P2】验证「唯一性校验」-「字段级-重复率」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「唯一性校验」-「字段级-重复数」-「固定值」-「校验异常」逻辑正确
...
##### 【P1】验证「唯一性校验」-「字段级-重复数」-「固定值」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-自定义正则」-「占比」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-自定义正则」-「占比」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-自定义正则」-「固定值」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-自定义正则」-「固定值」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式datetime」-「占比」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式datetime」-「占比」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式datetime」-「固定值」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式datetime」-「固定值」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式date」-「占比」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式date」-「占比」-「校验通过」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式date」-「固定值」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-格式校验-日期格式date」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「有效性校验」-「字段级-格式校验-身份证号」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「有效性校验」-「字段级-数值-取值范围检测」-「校验异常」逻辑正确
...
##### 【P1】验证「有效性校验」-「字段级-数值-取值范围检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「多表-多表数据内容对比」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「多表-多表数据内容对比」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「多表-多表行数比对」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「多表-多表行数比对」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-字段取值校验」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-字段取值校验」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「月度平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「月度平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「7天平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「7天平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「月度波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「月度波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「7天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「7天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「1天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「1天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「固定值」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串率检测」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「月度平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「月度平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「7天平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「7天平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「月度波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「月度波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「7天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「7天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「1天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「1天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「固定值」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空串数检测」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「月度平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「月度平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「7天平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「7天平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「月度波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「月度波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「7天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「7天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「1天波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「1天波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「固定值」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值率检测」-「固定值」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值数检测」-「月度平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值数检测」-「月度平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值数检测」-「7天平均值波动检测」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值数检测」-「7天平均值波动检测」-「校验通过」逻辑正确
...
##### 【P2】验证「完整性校验」-「字段级-空值数检测」-「固定值」-「校验异常」逻辑正确
...
##### 【P1】验证「完整性校验」-「字段级-空值数检测」-「固定值」-「校验通过」逻辑正确
...
##### 【P1】验证「完整性校验」-「表级-表行数检测」-「固定值」-「校验异常」逻辑正确
...
##### 【P2】验证「完整性校验」-「表级-表行数检测」-「固定值」-「校验通过」逻辑正确
