...
##### 【P2】验证开启缓存控制--缓存路径无权限--prejob--验证数据同步任务运行成功
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【数据开发-创建数据同步任务】页面 | 成功进入数据开发-创建数据同步任务页面，页面内容正常加载显示，无报错 |
...
##### 【P1】验证开启缓存控制--缓存路径无权限--session--验证数据同步任务运行成功
...
##### 【P1】验证补数据--session--验证数据同步任务session模式运行是否使用远端文件
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【数据开发-创建数据同步任务】页面 | 数据同步任务创建成功，系统给出创建成功提示，列表中出现新创建的记录 |
...
##### 【P2】验证关闭缓存控制--更新远端文件--验证重新部署release分支后重启调度运行数据同步任务远端文件正常更新
...
##### 【P1】验证开启缓存控制--更新远端文件--验证重新部署release分支后重启调度运行数据同步任务远端文件正常更新
...
##### 【P1】验证关闭缓存控制--prejob--验证mysql数据源执行数据同步任务控制台开启缓存prejob模式正常运行完成
...
##### 【P2】验证关闭缓存控制--session--验证mysql数据源执行数据同步任务控制台开启缓存session模式正常运行完成
...
##### 【P2】验证开启缓存控制--prejob--验证mysql数据源执行数据同步任务控制台开启缓存prejob模式正常运行完成
...
##### 【P1】验证开启缓存控制--session--验证mysql数据源执行数据同步任务控制台开启缓存session模式正常运行完成
...
##### 【P2】验证prejob--验证sqlserver数据源执行数据同步任务prejob模式正常运行完成
...
##### 【P2】验证prejob--验证postgresql数据源执行数据同步任务prejob模式正常运行完成
...
##### 【P1】验证prejob--验证mysql数据源执行数据同步任务prejob模式正常运行完成
...
##### 【P2】验证session--验证sqlserver数据源执行数据同步任务session模式正常运行完成
...
##### 【P2】验证session--验证postgresql数据源执行数据同步任务session模式正常运行完成
...
##### 【P1】验证session--验证mysql数据源执行数据同步任务session模式正常运行完成
...
##### 【P1】验证presql, postsql长时间--验证presql, postsql长时间执行数据同步正常运行完成
