---
suite_name: 【锦湖日丽】支持发布doris表到目标项目 v6.3.8
description: 【锦湖日丽】支持发布doris表到目标项目 v6.3.8
prd_version: v6.3.8
prd_path: ""
product: batch-works
tags:
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【任务发布界面--创建发布包--对象类型选择表】页面 | 底部结果框正常显示上述所建表表名 |
...
##### 【P2】验证doris表一键发布发布至不创建不对接schema数据源的项目发布失败
...
##### 【P1】验证对接schema项目--多表--验证doris表导入导出正常发布至目标项目
...
##### 【P2】验证对接schema项目--多表--验证doris表一键发布正常发布至目标项目
...
##### 【P2】验证对接schema项目--单表--验证doris表导入导出正常发布至目标项目
...
##### 【P1】验证对接schema项目--单表--验证doris表一键发布正常发布至目标项目
...
##### 【P2】验证创建schema项目--多表--验证doris表导入导出正常发布至目标项目
...
##### 【P1】验证创建schema项目--多表--验证doris表一键发布正常发布至目标项目
...
##### 【P1】验证创建schema项目--单表--验证doris表导入导出正常发布至目标项目
...
##### 【P2】验证创建schema项目--单表--验证doris表一键发布正常发布至目标项目
