...
##### 验证配置了发布目标和schema映射，任务导入导出发布功能 「P2」
...
##### 验证未配置schema映射，show.all.schema为false时，任务一键发布功能 「P2」
...
##### 验证未配置schema映射，show.all.schema为true时，任务一键发布功能 「P1」
...
##### 验证映射数据源为不同一doris集群，多任务一键发布功能 「P1」
...
##### 验证映射数据源为同一doris集群，多任务一键发布功能 「P2」
...
##### 验证映射数据源为不同一doris集群，配置schema映射，多对一，任务一键发布功能 「P2」
...
##### 验证映射数据源为同一doris集群，配置schema映射，多对一，任务一键发布功能 「P2」
...
##### 验证映射数据源为不同一doris集群，配置schema映射，一对一，任务一键发布功能 「P2」
...
##### 验证映射数据源为同一doris集群，配置schema映射，一对一，任务一键发布功能 「P1」
...
##### 验证映射数据源为不同doris集群，未配置schema映射，任务一键发布功能 「P2」
...
##### 验证映射数据源为同一doris集群，未配置schema映射，show.all.schema为false时，任务一键发布功能 「P2」
...
##### 验证映射数据源为同一doris集群，未配置schema映射，show.all.schema为true时，任务一键发布功能 「P1」
...
##### 验证配置项default.data.source.show.all.schema为false时，meta数据源-schema下拉框数据是否正确 「P1」
...
##### 验证配置项default.data.source.show.all.schema为true时，meta数据源-schema下拉框数据是否正确 「P2」
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入离线开发-项目A-数据源，点击非meta数据源doris1的映射配置按钮 | 1）弹出映射配置弹窗 |
