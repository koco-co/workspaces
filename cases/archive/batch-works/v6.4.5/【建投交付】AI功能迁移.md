...
##### 【P2】验证DM for oracle 数据查询-验证没有权限查询数据的角色
...
##### 【P1】验证DM for oracle 数据查询-验证有权限查询数据的角色
...
##### 【P2】验证DM for oracle 数据查询-验证查询不存在的表数据
...
##### 【P2】验证DM for oracle 数据查询-验证控制台查询上限小于1000，并设置下载上限大于1000，预览仅显示设置上限数据
...
##### 【P2】验证DM for oracle 数据查询-验证控制台查询上限大于1000，并设置下载上限小于1000，预览仅显示1000条数据
...
##### 【P2】验证DM for oracle 数据查询-验证控制台查询上限小于1000，预览仅显示设置上限数据
...
##### 【P2】验证DM for oracle 数据查询-验证控制台查询上限大于1000，预览仅显示1000条数据
...
##### 【P1】验证DM for oracle 数据查询-多表联合查询（join。。。on。。。）【跨库联合查询，同库联合查询】
...
##### 【P2】验证DM for oracle 数据查询-验证查询数据（avg）
...
##### 【P2】验证DM for oracle 数据查询-验证查询数据去重（distinct.）
...
##### 【P1】验证DM for oracle 数据查询-验证查询分组数据（Group...by...）
...
##### 【P1】验证DM for oracle 数据查询-验证查询数据之间的数据（between...and...）
...
##### 【P1】验证DM for oracle 数据查询-验证查询最高销售额数据（desc...limit）
...
##### 【P2】验证starrocks 数据查询-验证没有权限查询数据的角色
...
##### 【P1】验证starrocks 数据查询-验证有权限查询数据的角色
...
##### 【P2】验证starrocks 数据查询-验证查询不存在的表数据
...
##### 【P2】验证starrocks 数据查询-验证控制台查询上限小于1000，并设置下载上限大于1000，预览仅显示设置上限数据
...
##### 【P2】验证starrocks 数据查询-验证控制台查询上限大于1000，并设置下载上限小于1000，预览仅显示1000条数据
...
##### 【P2】验证starrocks 数据查询-验证控制台查询上限小于1000，预览仅显示设置上限数据
...
##### 【P2】验证starrocks 数据查询-验证控制台查询上限大于1000，预览仅显示1000条数据
...
##### 【P1】验证starrocks 数据查询-多表联合查询（join。。。on。。。）【跨库联合查询，同库联合查询】
...
##### 【P2】验证starrocks 数据查询-验证查询数据（avg）
...
##### 【P2】验证starrocks 数据查询-验证查询数据去重（distinct.）
...
##### 【P1】验证starrocks 数据查询-验证查询分组数据（Group...by...）
...
##### 【P1】验证starrocks 数据查询-验证查询数据之间的数据（between...and...）
...
##### 【P1】验证starrocks 数据查询-验证查询最高销售额数据（desc...limit）
...
##### 【P2】验证hivesql 数据查询-验证没有权限查询数据的角色
...
##### 【P1】验证hivesql 数据查询-验证有权限查询数据的角色
...
##### 【P2】验证hivesql 数据查询-验证控制台查询上限小于1000，并设置下载上限大于1000，预览仅显示设置上限数据
...
##### 【P2】验证hivesql 数据查询-验证控制台查询上限大于1000，并设置下载上限小于1000，预览仅显示1000条数据
...
##### 【P2】验证hivesql 数据查询-验证控制台查询上限小于1000，预览仅显示设置上限数据
...
##### 【P2】验证hivesql 数据查询-验证控制台查询上限大于1000，预览仅显示1000条数据
...
##### 【P1】验证hivesql 数据查询-多表联合查询（join。。。on。。。）【跨库联合查询，同库联合查询】
...
##### 【P2】验证hivesql 数据查询-验证查询数据去重（distinct.）
...
##### 【P1】验证hivesql 数据查询-验证查询分组数据（Group...by...）
...
##### 【P1】验证hivesql 数据查询-验证查询数据之间的数据（between...and...）
...
##### 【P1】验证hivesql 数据查询-验证查询最高销售额数据（desc...limit）
...
##### 【P2】验证oushu 数据查询-验证控制台查询上限小于1000，并设置下载上限大于1000，预览仅显示设置上限数据
...
##### 【P2】验证oushu 数据查询-验证控制台查询上限大于1000，并设置下载上限小于1000，预览仅显示1000条数据
...
##### 【P2】验证oushu 数据查询-验证控制台查询上限小于1000，预览仅显示设置上限数据
...
##### 【P2】验证oushu 数据查询-验证控制台查询上限大于1000，预览仅显示1000条数据
...
##### 【P1】验证oushu 数据查询-多表联合查询（join。。。on。。。）【跨库联合查询，同库联合查询】
...
##### 【P2】验证oushu 数据查询-验证查询数据去重（distinct.）
...
##### 【P1】验证oushu 数据查询-验证查询分组数据（Group...by...）
...
##### 【P1】验证oushu 数据查询-验证查询数据之间的数据（between...and...）
...
##### 【P1】验证oushu 数据查询-多个表具有相同的comment
...
##### 【P1】验证oushu 数据查询-验证查询最高销售额数据（desc...limit）
...
##### 【P1】验证通用功能 数据查询-验证查询的表名，表字段comment有中文
...
##### 【P2】验证通用功能 数据查询-验证查询的sql类型不支持的情况
...
##### 【P2】验证代码续写——验证sql输入错误的语法、关键字、函数进行智能优化ai如何应对
...
##### 【P2】验证代码续写——验证sql输入离线不支持的sql语法、函数进行智能优化ai如何应对
...
##### 【P2】验证代码续写——验证不存在任何sql语句进行智能优化ai如何应对
...
##### 【P2】验证代码续写——验证使用正确且完整的sql智能优化ai如何应对
...
##### 【P2】验证智能诊断——验证由于无数据源或数据源链接失败等其他非sql原因报错进行日志智能解析ai如何应对
...
##### 【P2】验证智能诊断——验证无sql报错时进行日志智能解析ai如何应对
...
##### 【P2】验证智能解释——验证sql输入错误的语法、关键字、函数进行智能解释ai如何应对
...
##### 【P2】验证智能解释——验证sql输入离线不支持的sql语法、函数进行智能解释ai如何应对
...
##### 【P2】验证智能解释——验证不输入任何sql进行智能解释ai如何应对
...
##### 【P2】验证智能解释——验证对同一sql多次进行智能解释ai如何应对
...
##### 【P2】验证智能注释——验证sql输入错误的语法、关键字、函数进行智能注释ai如何应对
...
##### 【P2】验证智能注释——验证sql输入离线不支持的sql语法、函数进行智能注释ai如何应对
...
##### 【P2】验证智能注释——验证不输入任何sql进行智能注释ai如何应对
...
##### 【P2】验证智能注释——验证已添加注释的sql进行智能注释ai如何应对
...
##### 【P2】验证智能优化——验证sql输入错误的语法、关键字、函数进行智能优化ai如何应对
...
##### 【P2】验证智能优化——验证sql输入离线不支持的sql语法、函数进行智能优化ai如何应对
...
##### 【P2】验证智能优化——验证不存在任何sql语句进行智能优化ai如何应对
...
##### 【P2】验证智能优化——验证使用正确且完整的sql智能优化ai如何应对
...
##### 【P1】验证智能诊断——验证prd所提任务不支持日志智能解析功能
...
##### 【P2】验证starrocks 智能诊断——验证starrocks SQL周期任务补数据实例运行日志智能解析功能正常使用
...
##### 【P2】验证starrocks 智能诊断——验证starrocksSQL周期任务实例运行日志智能解析功能正常使用
...
##### 【P2】验证starrocks 智能诊断——验证starrocksSQL临时查询任务日志智能解析功能正常使用
...
##### 【P2】验证starrocks 智能诊断——验证starrocks SQL手动任务日志智能解析功能正常使用
...
##### 【P2】验证starrocks 智能诊断——验证starrocksSQL周期任务日志智能解析功能正常使用
...
##### 【P2】验证starrocks 智能优化——验证starrocks SQL手动任务智能优化、注释、解释正常使用
...
##### 【P2】验证starrocks 智能优化——验证starrocks SQL周期任务智能优化、注释、解释正常使用
...
##### 【P2】验证starrocks 智能优化——验证starrocks SQL临时查询任务智能优化、注释、解释正常使用
...
##### 【P1】验证dm for oracle 智能诊断——验证dm for oracle SQL周期任务补数据实例运行日志智能解析功能正常使用
...
##### 【P1】验证dm for oracle 智能诊断——验证dm for oracleSQL周期任务实例运行日志智能解析功能正常使用
...
##### 【P1】验证dm for oracle 智能诊断——验证dm for oracleSQL临时查询任务日志智能解析功能正常使用
...
##### 【P1】验证dm for oracle 智能诊断——验证dm for oracle SQL手动任务日志智能解析功能正常使用
...
##### 【P1】验证dm for oracle 智能诊断——验证dm for oracleSQL周期任务日志智能解析功能正常使用
...
##### 【P1】验证dm for oracle 智能优化——验证dm for oracle SQL手动任务智能优化、注释、解释正常使用
...
##### 【P1】验证dm for oracle 智能优化——验证dm for oracle SQL周期任务智能优化、注释、解释正常使用
...
##### 【P1】验证dm for oracle 智能优化——验证dm for oracle SQL临时查询任务智能优化、注释、解释正常使用
...
##### 【P2】验证oushu 智能诊断——验证oushu SQL周期任务补数据实例运行日志智能解析功能正常使用
...
##### 【P2】验证oushu 智能诊断——验证oushuSQL周期任务实例运行日志智能解析功能正常使用
...
##### 【P2】验证oushu 智能诊断——验证oushuSQL临时查询任务日志智能解析功能正常使用
...
##### 【P2】验证oushu 智能诊断——验证oushu SQL手动任务日志智能解析功能正常使用
...
##### 【P2】验证oushu 智能诊断——验证oushuSQL周期任务日志智能解析功能正常使用
...
##### 【P2】验证oushu 智能优化——验证oushu SQL手动任务智能优化、注释、解释正常使用
...
##### 【P2】验证oushu 智能优化——验证oushu SQL周期任务智能优化、注释、解释正常使用
...
##### 【P2】验证oushu 智能优化——验证oushu SQL临时查询任务智能优化、注释、解释正常使用
...
##### 【P1】验证hive 智能诊断——验证hive SQL周期任务补数据实例运行日志智能解析功能正常使用
...
##### 【P1】验证hive 智能诊断——验证hiveSQL周期任务实例运行日志智能解析功能正常使用
...
##### 【P1】验证hive 智能诊断——验证hiveSQL临时查询任务日志智能解析功能正常使用
...
##### 【P1】验证hive 智能诊断——验证hive SQL手动任务日志智能解析功能正常使用
...
##### 【P1】验证hive 智能诊断——验证hiveSQL周期任务日志智能解析功能正常使用
...
##### 【P1】验证hive 智能优化——验证hive SQL手动任务智能优化、注释、解释正常使用
...
##### 【P1】验证hive 智能优化——验证hive SQL周期任务智能优化、注释、解释正常使用
...
##### 【P1】验证hive 智能优化——验证hive SQL临时查询任务智能优化、注释、解释正常使用
...
##### 【P1】验证查询表使用约束类型（PRIMARY KEY）的字段有哪些
...
##### 【P1】验证查询public库下的test_oushu_biao1后接着查询public_1库下的表test_oushu_biao3数据内容正常
...
##### 【P1】验证存在上下文的情况下切换左侧任务框为其他数据源后询问返回当前任务框所属数据源类型结果
...
##### 【P2】验证存在上下文的情况下切换左侧任务框为其他同类型数据源不同schema后询问返回当前任务框所指定schema结果（不创建和不对接项目专属用例）
...
##### 【P2】验证查询oushu数据源下的test_oushu_biao1后接着查询mysql下的表test_mysql_biao1数据内容是否正常
...
##### 【P1】验证存在上下文的情况下切换项目后询问是否返回所切换项目的数据结果
...
##### 【P2】验证不创建不对接schema的数据源建表后正常通过ai询问
