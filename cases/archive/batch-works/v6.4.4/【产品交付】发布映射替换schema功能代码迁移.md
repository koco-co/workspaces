---
suite_name: 【产品交付】发布映射替换schema功能代码迁移 v6.4.4
description: 【产品交付】发布映射替换schema功能代码迁移 v6.4.4
prd_version: v6.4.4
prd_path: ""
product: batch-works
tags:
...
##### 【P1】验证Hive2StarRocks多任务一键发布功能正常(映射数据源: Hive不同、SR不同, 多对一Schema映射)
...
##### 【P1】验证Hive2StarRocks任务一键发布功能正常(映射数据源: Hive相同、SR不同, 多对一Schema映射)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-项目A】页面，创建hive2sr数据同步任务：source：hiveA-schemaA-table1sink: srA-scheam1-table2保存提交任务 | 系统提示提交成功，记录状态更新，列表中可见该条记录 |
...
##### 【P1】验证Hive2StarRocks任务一键发布功能正常(映射数据源: Hive不同、SR不同, 一对一Schema映射)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-项目A】页面，创建Hive2StarRocks数据同步任务：source端：hiveA(meta)-schemaA-table1sink端: srA(meta)-scheamA-table2保存提交任务 | 系统提示提交成功，记录状态更新，列表中可见该条记录 |
...
##### 【P2】验证Hive2StarRocks任务一键发布功能正常(映射数据源: Hive不同、SR不同, 无Schema映射, 配置项=false)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-Project03】页面，创建数据同步任务: hive2sr_01, 配置如下:source端: hiveA-schemaA-table1sink端: srA-scheamA-table2其它配置项正常填写, 保存后提交任务 | 系统提示提交成功，记录状态更新，列表中可见该条记录 |
| 2 | 进入发布任务页面，打包hive2sr | 打包成功，系统给出成功反馈，相关页面/数据状态更新为最新 |
| 3 | 进入发布至目标项目页面，点击发布 | 弹出校验弹窗，校验都通过 |
| 4 | 点击确定 | 系统提示发布成功，发布状态更新，相关页面可访问 |
...
##### 【P2】验证Hive2StarRocks任务一键发布功能正常(映射数据源: Hive相同、SR相同, 无Schema映射, 配置项=true)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-Project01】页面，创建数据同步任务: hive2sr_01, 配置如下:source端: hiveA-schemaA-table1sink端: srA-scheamB-table2其它配置项正常填写, 保存后提交任务 | 系统提示提交成功，记录状态更新，列表中可见该条记录 |
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-项目A-数据源】页面，点击doris1的映射配置按钮, 发布目标选择doris2，查看目标项目schema下拉框 | 1）弹出映射配置弹窗2）返回doris2数据源下的所有schema |
...
##### 【P2】验证Meta数据源-Schema下拉框数据正确(配置项=false)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-项目A-数据源】页面，点击dorisA1的映射配置按钮, 查看本项目schema下拉框 | 1）弹出映射配置弹窗2）返回dorisA1的默认Schema（数据源列表连接信息中的schema） |
...
##### 【P1】验证Meta数据源-Schema下拉框数据正确(配置项=true)
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-项目A-数据源】页面，点击dorisA1的映射配置按钮, 查看本项目schema下拉框 | 1）弹出映射配置弹窗2）返回dorisA1数据源下的所有schema |
