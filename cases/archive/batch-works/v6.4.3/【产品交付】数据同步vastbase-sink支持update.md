...
##### 【P2】验证数据来源为mysql数据源，vastbase作为目标端时，主键冲突选择insert任务正常运行
...
##### 【P2】验证数据来源为spark数据源，vastbase作为目标端时，主键冲突无法选择on duplicate key update
...
##### 【P2】验证手动任务 手动任务运行——验证上述数据同步任务运维中心手动运行正常
...
##### 【P1】验证数据来源为oracle数据源，vastbase作为目标端时，主键冲突选择on duplicate key update任务正常运行
...
##### 【P1】验证数据来源为mysql数据源，vastbase作为目标端时，主键冲突选择on duplicate key update任务正常运行
...
##### 【P1】验证数据来源为inceptor数据源，vastbase作为目标端时，主键冲突选择on duplicate key update任务正常运行
...
##### 【P1】验证数据来源为inceptor、mysql、oracle数据源，vastbase作为目标端时，主键冲突支持可选on duplicate key update
...
##### 【P2】验证数据来源为spark数据源，vastbase作为目标端时，主键冲突无法选择 update
...
##### 【P2】验证周期任务 周期运行——验证上述数据同步任务周期运行正常
...
##### 【P1】验证数据来源为inceptor、mysql、oracle数据源，vastbase作为目标端时，主键冲突支持可选update
