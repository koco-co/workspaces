...
##### 【P2】验证 DorisSQL任务调度功能运行正常(DQL语法)
...
##### 【P2】验证 DorisSQL任务调度功能运行正常(DML语法)
...
##### 【P1】验证 DorisSQL任务调度功能运行正常(DDL语法)
...
##### 【P2】验证【创建项目】添加Doris数据源显示正常(初始化方式: 不创建且不对接)
...
##### 【P2】验证【创建项目】添加Doris 数据源显示正常(初始化方式: 对接)
...
##### 【P1】验证【创建项目】添加Doris 数据源显示正常(初始化方式: 创建)
...
##### 【P2】验证 Doris3.x 同步任务导入前后准备语句执行有效
...
##### 【P2】验证数据同步功能正常(Other → Doris3.x、per_job模式)
...
##### 【P1】验证数据同步功能正常(Doris3.x → Other、session模式)
