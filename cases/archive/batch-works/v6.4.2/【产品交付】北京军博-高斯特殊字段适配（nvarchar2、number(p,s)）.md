---
suite_name: "【产品交付】北京军博-高斯特殊字段适配（nvarchar2、number(p,s)） v6.4.2"
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-数据开发-新建手动任务】页面，source端选择pg数据源，source表，点击下一步 | 进入目标端配置页面 |
...
| 编号 | 步骤 | 预期 |
| --- | --- | --- |
| 1 | 进入【离线开发-数据开发-新建周期任务】页面，source端选择pg数据源，source表，点击下一步 | 进入目标端配置页面 |
