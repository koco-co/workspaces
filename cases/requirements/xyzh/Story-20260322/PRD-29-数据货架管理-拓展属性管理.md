...
![拓展属性管理列表页，按资产类型分Tab展示属性](../../../../../asset/assets/images/拓展属性管理列表页-按资产类型分Tab展示属性.png) 
...
#### 1.1.1.3. **流程逻辑**
![拓展属性编辑流程图，含枚举删除校验与后端校验逻辑](../../../../../asset/assets/images/拓展属性编辑流程图-含枚举删除校验与后端校验逻辑.png) 
...
点击【编辑】进入对应编辑页面。
![枚举属性编辑弹窗，含基本信息与选项内容配置](../../../../../asset/assets/images/枚举属性编辑弹窗-含基本信息与选项内容配置.png)
