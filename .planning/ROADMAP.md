...
- [x] 03-03-PLAN.md — SKILL.md Step 0 dialog orchestration + end-to-end validation
...
**Verification:** automated checks passed; human smoke verification required — see `.planning/phases/04-core-skills-redesign/04-VERIFICATION.md`

Plans:
- [x] 04-01-PLAN.md — xmind-converter generalization (isDtstackMeta removal, config-driven title builders, SKILL.md update)
- [x] 04-02-PLAN.md — archive-converter generalization (module map config-driven, output path resolution, SKILL.md update)
- [x] 04-03-PLAN.md — prd-enhancer generalization + code-analysis-report frontend Mode C extension
- [x] 04-04-PLAN.md — test-case-generator prompts e-commerce examples + conditional step logic
- [x] 04-05-PLAN.md — using-qa-flow menu sync + CLAUDE.md Skill index update
...
| 4. Core Skills Redesign | 5/5 | Awaiting human verification |  |
