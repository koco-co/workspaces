---
suite_name: "【规则任务配置优化】一个数据表支持创建多个质量规则任务"
description: "【规则任务配置优化】一个数据表支持创建多个质量规则任务用例归档"
tags:
  - "变更"
  - "多表"
  - "单表"
...
SELECT * FROM table1;
4、历史已存在table1的1个规则任务test_rule，报告名称为“table1质量报告”
```
