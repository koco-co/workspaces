...
##### 【P0】【P0】验证在规则集中配置取值范围&枚举范围规则且关系完整流程（数值类型字段）
...
##### 【P1】【P1】验证在规则集中配置取值范围&枚举范围规则或关系时保存成功
...
##### 【P1】【P1】验证原有枚举值规则同步新增not in选项且可正常保存
...
##### 【P1】【P1】验证string类型字段在规则集中配置取值范围&枚举范围规则时系统可正常保存
...
##### 【P1】【P1】验证取值范围设置期望值已填写但操作符未选择时点击保存提示校验错误
...
##### 【P1】【P1】验证枚举值下拉框已选择in但值输入框为空时点击保存提示校验错误
...
##### 【P1】【P1】验证取值范围和枚举值均已填写但关系未选择时点击保存提示校验错误
...
##### 【P1】【P1】验证取值范围和枚举值均未填写时点击保存提示至少填写一项
...
##### 【P1】【P1】验证在规则集中已保存的且关系规则编辑切换为或关系后保存成功
...
##### 【P2】【P2】验证在规则集中取值范围&枚举范围规则支持克隆且克隆后配置内容与原规则一致
...
##### 【P0】【P0】验证执行含取值范围&枚举范围且关系规则的任务后质量报告展示正确
...
##### 【P1】【P1】验证执行含取值范围&枚举范围或关系规则的任务后校验通过
...
##### 【P2】【P2】验证结合抽样功能执行取值范围&枚举范围校验结果正确
...
##### 【P2】【P2】验证对分区表指定分区执行取值范围&枚举范围校验结果正确
...
##### 【P1】【P1】验证规则库中新增取值范围&枚举范围内置规则展示正确
...
##### 【P1】【P1】验证取值范围&枚举范围规则校验不通过时可查看明细且校验字段标红展示
...
##### 【P1】【P1】验证取值范围&枚举范围规则校验不通过时下载明细数据中校验字段标红展示
...
##### 【P1】【P1】验证取值范围&枚举范围规则校验通过时不记录明细数据且操作列不显示查看详情
...
##### 【P1】【P1】验证仅配置枚举值in校验通过时质量报告详情说明使用枚举值独立说明模板
...
##### 【P1】【P1】验证仅配置枚举值in校验不通过时质量报告详情说明包含越界值数量统计
...
##### 【P1】【P1】验证仅配置枚举值not in校验不通过时质量报告详情说明展示not in规则描述
