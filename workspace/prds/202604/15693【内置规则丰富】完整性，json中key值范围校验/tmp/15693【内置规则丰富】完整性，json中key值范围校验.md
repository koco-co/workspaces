...
![页面截图-1](../images/1-15693_内置规则丰富_完整性_json中key值范围校验.png)

![页面截图-2](../images/2-15693_内置规则丰富_完整性_json中key值范围校验.txt)

![页面截图-3](../images/3-15693_内置规则丰富_完整性_json中key值范围校验_styles.json)
