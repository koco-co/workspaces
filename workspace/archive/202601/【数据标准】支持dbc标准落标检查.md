---
suite_name: "【数据标准】支持dbc标准落标检查"
description: "【数据标准】支持dbc标准落标检查用例归档"
tags:
  - "版块"
  - "选择"
  - "文件"
...
##### 【P0】验证【标准管理】-【落标检查】-【落标检查任务】-【编辑检查任务】流程运转
...
| 1 | 进入【资产】-【数据标准】-【标准管理】-【落标检查】页面 | 进入成功 |
| 2 | 定位到测试用任务 【test】，点击 [编辑] 按钮 | 进入 [检查范围] 配置页面 |
| 3 | [检查范围] 配置如下： 「选择数据源」选择「${DATASOURCE}」 「选择数据库」选择「${DATABASE}」 「选择数据表」选择「${TABLE}」 [选择分区] 选择 [选择已有分区] [标准目录] 选择 [test_rule] | [检查范围] 配置完成 |
| 4 | 点击 [下一步] 按钮 | 进入 [选择字段] 配置页面 |
| 5 | [检查范围] 配置如下： [检查字段列表] 勾选部分字段，是否开启检查为开启，检查项为全部 [规则包数量] 选择 [1] | [选择字段] 配置完成 |
| 6 | 点击 [下一步] 按钮 | 进入 [调度配置] 配置页面 |
| 7 | [检查范围] 配置如下： [调度周期] 天 [生效日期] 默认 [具体时间] 默认 [告警通知] 钉钉 | [调度配置] 配置完成 |
...
##### 【P0】验证【标准管理】-【落标检查】-【落标检查任务】-【新建检查任务】流程运转
...
| ---- | ---- | ---- |
| 1 | 进入【资产】-【数据标准】-【标准管理】-【落标检查】页面 | 进入成功 |
| 2 | UI Check | 【落标检查设置】 [数据表名/字段名搜索框][新建检查任务按钮][勾选框] [数据表名称][所属数据源][所属数据库][检查字段数/总字段数][检查周期][检查状态][标准达标率][不达标字段数/检查失败数][最近编辑时间][最近检查时间][操作（编辑/查看检查结果）] [批量开启按钮][批量关闭按钮] [分页栏] 以上内容正常显示 |
...
| ---- | ---- | ---- |
| 1 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入成功 |
| 2 | UI Check | 【落标检查总览】 [检查数据表][检查字段总数][达标字段数][标准达标率] 以上内容正常显示 |
...
##### 【P0】验证【标准管理】-【标准映射】-【映射记录】展示记录数量1000条扩充为10000条
...
##### 【P0】验证【标准管理】-【标准映射】-【映射记录】支持数据表维度查询映射结果
...
| 3 | 【标准映射】配置如下： [标准目录] tst [数据标准] test [数据源类型] MySQL-test-test1 | 【数据表】支持“多选”/“全部”/“单选” |
| 4 | 确认【数据表】是否支持“多选”/“全部”/“单选” |  |
...
| 1 | 进入【标准管理】-【标准映射】 | 进入成功 |
| 2 | 点击【标准映射】按钮 | 进入[标准映射]配置页面 |
| 3 | 【标准映射】配置如下： [标准目录] tst [数据标准] test [数据源类型] MySQL-test-“全部” | 【数据表】默认选择全部 |
| 4 | 确认【数据表】是否默认选择全部 |  |
| 5 | 锁不锁操作？ |  |
...
| 1 | 进入【标准管理】-【标准映射】 | 进入成功 |
| 2 | 点击【标准映射】按钮 | 进入[标准映射]配置页面 |
| 3 | 【标准映射】配置如下： [标准目录] tst [数据标准] test [数据源类型] MySQL | 数据源类型无“全选”项且根据选择变为“MySQL‘，数据库支持“全选“/”多选”/“单选” |
| 4 | 确认【数据源】是否仅支持单选，且数据库支持“全选“/”多选”/“单选” |  |
...
| 1 | 进入【标准管理】-【标准映射】 | 进入成功 |
| 2 | 点击【标准映射】按钮 | 进入[标准映射]配置页面 |
| 3 | 【标准映射】配置如下： [标准目录] tst [数据标准] test | 数据源类型根据选择变为“全部‘，数据源、数据库、数据表均默认选择全部且无法操作 |
| 4 | 【数据源类型】尝试选择“全部” |  |

##### 【P0】验证【标准管理】-【标准映射】-【映射目标】选择到数据表新建映射后能正常运转
...
| 1 | 进入【标准管理】-【标准映射】 | 进入成功 |
| 2 | 点击【标准映射】按钮 | 进入[标准映射]配置页面 |
| 3 | 【标准映射】配置如下： [标准目录] tst [数据标准] test [映射目标] MySQL-test_MYSQL-test-test | [标准映射]配置完毕 |
| 4 | 点击【确定】按钮 | 成功生成映射任务 |
| 5 | 点击【确定】按钮 | 成功生成映射任务 |
...
| 6 | 【标准映射】配置如下： [标准目录] tst [数据标准] test [映射目标] 设定数据源 | [标准映射]配置完毕 |
| 7 | 点击【确定】按钮 | 成功生成映射任务 |
...
##### 【P0】验证【数据标准】-【标准定义】标准进行“下线”操作时判断是否存在落标检查任务
...
| 编号 | 步骤 | 预期 |
| ---- | ---- | ---- |
| 1 | 打开下载的导入模板文件，按规则填写内容（根据失败类型对应填写测试且分为两种情况测试：1、原标准与文档标准存在该情况 2、文档标准存在该情况） | 点击【导入标准】按钮 |
| 2 | 测试场景1【相同标准名称】 | 点击【导入标准】按钮 |
| 3 | 测试场景2【同一个“英文名称”标准的不同车型业务属性不同】 | 点击【导入标准】按钮 |
| 4 | 测试场景3【填写字段不符合要求格式】 | 点击【导入标准】按钮 |
| 5 | 【存在多个失败原因，用英文分号分割展示】 | 点击后自动下载导入异常记录文件，文件中包含导入数据和失败原因，失败原因一列展示 |
| 6 | 点击下载【异常记录】按钮 | 确认导入失败记录未出现在列表中 |
| 7 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 |  |
...
| 编号 | 步骤 | 预期 |
| ---- | ---- | ---- |
| 1 | 都有车型车系，现有标准与导入标准车型车系重复 | 进入成功 |
| 2 | 打开下载的导入模板文件，按规则填写内容（根据四种情况填写对应实例） | 进入[导入标准]配置页面 |
| 3 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | [导入标准]配置完成 |
| 4 | 点击【导入标准】按钮 | 显示导入结果【导入总量/导入成功/导入失败/下载异常记录】 |
| 5 | 导入标准配置如下： [重复处理规则] 重复则覆盖更新 [上传文件] *上传填写后的文件*（对应不同测试场景上传对应文件） 场景1文件 场景2文件 场景3文件 场景4文件 | 场景1，重复标准覆盖更新 |
| 6 | 点击【确认】按钮 |  |
| 7 | 查看【资产】-【数据标准】-【标准管理】-【标准定义】页面，依照场景检查用例指向的标准 |  |
...
| 编号 | 步骤 | 预期 |
| ---- | ---- | ---- |
| 1 | 打开下载的导入模板文件，按规则填写内容（与现有标准没有重复现象） | 进入成功 |
| 2 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入[导入标准]配置页面 |
| 3 | 点击【导入标准】按钮 | [导入标准]配置完成 |
| 4 | 导入标准配置如下： [重复处理规则] 重复则覆盖更新 [上传文件] *上传填写后的文件* | 显示导入结果【导入总量/导入成功/导入失败/下载异常记录】 |
| 5 | 点击【确认】按钮 |  |
...
| 编号 | 步骤 | 预期 |
| ---- | ---- | ---- |
| 1 | 打开下载的导入模板文件，按规则填写内容，保存为PDF，PSD类型两份文件 | 进入成功 |
| 2 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入[导入标准]配置页面 |
| 3 | 点击【导入标准】按钮 | 成功提交 |
| 4 | 点击【上传文件】按钮，提交导入文件（PDF文件） | 导入失败，提示“导入表格未按照模版要求导入，请检查后重新导入！” |
| 5 | 点击【确认】按钮 | 成功提交 |
| 6 | 点击【上传文件】按钮，提交导入文件（PSD文件） | 导入失败，提示“导入表格未按照模版要求导入，请检查后重新导入！” |
| 7 | 点击【确认】按钮 |  |

##### 【P0】验证【导入模板】xls、xlsx格式导入流程正常运转
...
| 2 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入[导入标准]配置页面 |
| 3 | 点击【导入标准】按钮 | 成功提交 |
| 4 | 点击【上传文件】按钮，提交导入文件（XLSX文件） | 成功导入，显示导入结果【导入总量/导入成功/导入失败/下载异常记录】 |
| 5 | 点击【确认】按钮 | 成功提交 |
| 6 | 点击【上传文件】按钮，提交导入文件（XLS文件） | 显示导入结果【导入总量/导入成功/导入失败/下载异常记录】 |
| 7 | 点击【确认】按钮 |  |
...
| 3 | 技术配置配置如下： [是否复制属性] 勾选 | 【新建标准】-[技术配置]配置完成 |
| 4 | 点击【车型】选择框，将【车型】属性改为车型2 | 数据更改成功，【技术属性】版块更新，【是否复制属性】变更为【是否将 车型1 属性粘贴到 车型2 ？】且后置确认按钮，其他内容清空 |
| 5 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据长度] <=5 [数据精度] 1/1 [数据类型] 数值型 [是否允许空值] 是 [是否允许重复] 否 [默认值] 20 [取值范围] >10 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
...
| 1 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入成功 |
| 2 | 点击【新建标准】按钮 | 进入[新建标准]配置页面 |
| 3 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据类型] 数值型 [是否允许空值] 是 [是否允许重复] 是 [默认值] 1 [取值范围] >1 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
| 4 | 点击【车型】选择框，将【车型】属性改为车型2 | 数据更改成功，【技术属性】版块更新，【是否复制属性】变更为【是否将 车型1 属性粘贴到 车型2 ？】且后置确认按钮，其他内容清空 |
| 5 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据长度] <=5 [数据精度] 1/1 [数据类型] 数值型 [是否允许空值] 是 [是否允许重复] 否 [默认值] 20 [取值范围] >10 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
| 6 | 点击【是否将 车型1 属性粘贴到 车型2 ？】框的确认按钮 | 原车型1填写内容填充到了现车型2的配置中，覆盖逻辑如下： 重复填写内容，车型1覆盖车型2 车型1未填写车型2填写，不作覆盖 车型1填写车型2未填写，填充车型1内容 |
...
| 1 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入成功 |
| 2 | 点击【新建标准】按钮 | 进入[新建标准]配置页面 |
| 3 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据类型] 数值型 [数据长度] <=5 [数据精度] 1/1 [是否允许空值] 是 [是否允许重复] 是 [默认值] 1 [取值范围] >1 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
| 4 | 点击【车型】选择框，将【车型】属性改为车型2 | 数据更改成功，【技术属性】版块更新，【是否复制属性】变更为【是否将 车型1 属性粘贴到 车型2 ？】且后置确认按钮，其他内容清空 |
| 5 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据类型] 数值型 [是否允许空值] 是 [是否允许重复] 否 [默认值] 20 [取值范围] >10 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
...
| 3 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据类型] 数值型 [数据长度] <=5 [数据精度] 1/1 [是否允许空值] 是 [是否允许重复] 是 [默认值] 1 [取值范围] >1 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
| 4 | 点击【车型】选择框，将【车型】属性改为车型2 | 数据更改成功，【技术属性】版块更新，【是否复制属性】变更为【是否将 车型1 属性粘贴到 车型2 ？】且后置确认按钮，其他内容清空 |
| 5 | 技术配置配置如下： [车系] 车系1 [车型] 车型1 [是否复制属性] 勾选 [数据类型] 数值型 [数据长度] <=10 [数据精度] 3/5 [是否允许空值] 是 [是否允许重复] 否 [默认值] 20 [取值范围] >10 [枚举列表] 不作调整 | 【新建标准】-[技术配置]配置完成 |
...
##### 【P0】验证【标准管理】-【标准定义】-【技术属性】-【车型/车系】使用数据复制功能复制数据后，流程可正常运转
...
##### 【P0】验证【标准管理】-【标准定义】中新增字段填写后流程正常运转（多条车系/车型相关技术属性）
...
| 6 | 业务属性配置如下： [中文名称] 最大功率 [英文名称] Maximum power [英文缩写] MaxP [标准目录] tst [车系/车型] 奔驰E级/2026_L_4MATIC；奔驰E级/2025_L_4MATIC；奔驰E级/2024_L_4MATIC | 【技术属性】配置完成 |
| 7 | 技术属性配置如下： [数据类型] 数值型 [数据长度] <=5 [数据精度] 4/3 [是否允许空值] 否 [是否允许重复] 是 [默认值] 不作填写 [初始值] 不作填写 [无效值] 500 [精度倍数] 1.1 [偏移量] 20 | 【技术属性】配置完成 |
...
##### 【P0】验证【标准管理】-【标准定义】中新增字段填写后流程正常运转
...
| 2 | 点击【导入标准】按钮 | 进入[导入标准]配置页面 |
| 3 | 点击【下载模板】按钮 | 自动下载导入模板 |
| 4 | 打开下载文件，按规则填写内容 | 进入成功 |
| 5 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入[导入标准]配置页面 |
| 6 | 点击【导入标准】按钮 | 成功提交 |
| 7 | 点击【上传文件】按钮，提交导入文件 | 成功导入，显示导入结果【导入总量/导入成功/导入失败/下载异常记录】 |
| 8 | 点击【确认】按钮 | 导入成功 |
| 9 | 找到导入的标准（未填写英文缩写），确认标准导入成功 |  |
...
| 1 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入成功 |
| 2 | 点击【新建标准】按钮 | 进入[新建标准]配置页面 |
| 3 | 业务属性配置如下： [中文名称] 测试 [英文名称] Test_&Box [英文缩写] 不作填写 [标准目录] tst （非必填项不作填写） | [新建标准]配置完成 |
...
| 1 | 进入【资产】-【数据标准】-【标准管理】-【标准定义】页面 | 进入成功 |
| 2 | 点击【新建标准】按钮 | 进入[新建标准]配置页面 |
| 3 | 业务属性配置如下： [中文名称] 测试 [英文名称] Test_&Box [英文缩写] t_b [标准目录] tst （非必填项不作填写） | [新建标准]配置完成 |
| 4 | 点击【保存】按钮 | 弹出提示“数据标准保存成功”，返回【标准定义】页面 |
| 5 | 点击【新建标准】按钮 | 进入[新建标准]配置页面 |
| 6 | 业务属性配置如下： [中文名称] 测试 [英文名称] Test &Box Test_&box [英文缩写] t b T_b t_B [标准目录] tst （非必填项不作填写） | [新建标准]配置完成 |
| 7 | 点击【保存】按钮 | 弹出提示“数据标准保存成功”，返回【标准定义】页面 |

##### 【P0】验证【英文名称】进行重复性校验，存在重复提示“已存在相同标准”
