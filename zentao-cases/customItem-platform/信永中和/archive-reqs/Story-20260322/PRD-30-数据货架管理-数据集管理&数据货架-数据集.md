...
![手工数据集新增、编目、发布与上下架流程图](../../../../../images/手工数据集新增-编目-发布与上下架流程图.png) 
...
包含以下功能：
![数据集管理列表页，含目录树、搜索与状态操作按钮](../../../../../images/数据集管理列表页-含目录树-搜索与状态操作按钮.png)
...
详见原型与附录7—#3。
![数据集编目页第一步，基本信息与拓展属性填写表单](../../../../../images/数据集编目页第一步-基本信息与拓展属性填写表单.png)
![数据集编目页第二步，字段信息录入表格](../../../../../images/数据集编目页第二步-字段信息录入表格.png) 
