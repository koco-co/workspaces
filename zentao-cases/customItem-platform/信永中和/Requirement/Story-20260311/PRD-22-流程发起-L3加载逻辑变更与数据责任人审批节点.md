...
![选中L2后加载L3明细逻辑图](CustomItem/信永中和/v0.2.1/Story-20260311/media/image110.png)

#### 各流程加载逻辑

**数据安全定级流程**：

![数据安全定级-L3加载逻辑](CustomItem/信永中和/v0.2.1/Story-20260311/media/image110.png)

**数据源认证流程**：

![数据源认证-L3加载逻辑](CustomItem/信永中和/v0.2.1/Story-20260311/media/image115.png)

**主数据识别流程**：

![主数据识别-L3加载逻辑](CustomItem/信永中和/v0.2.1/Story-20260311/media/image120.png)

**数据目录发布流程**：

![数据目录发布-L3加载逻辑](CustomItem/信永中和/v0.2.1/Story-20260311/media/image110.png)
